...
module.exports = function runEngine (method, guard) {
  return {
    // guard means this property will be "frozen" once the game is finished
    deps: ['fen'].concat(guard ? ['_finished', 'freezeOnFinish'] : []),
    fn: function () {
      var value
      ...
      if (guard && this.freezeOnFinish && this._cache.hasOwnProperty(guard) && this._finished) {
